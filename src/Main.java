...
public class Main {
    ...
    public static final String EXIST_DUPLICATED_PHONES = "EP";
    ...
    private static void verifyNumbers(ContactBook cBook) {
        if(cBook.allDifferent()) {
